...
const returnedContentBudgetBytes = 4_500;

function resultChannels(args) {
...
export async function deliverLargeJsonResult({ tool, args, runtime, payload, sourcePaths, identity }) {
...
async function writeIdempotentJsonArtifact(output, payload) {
